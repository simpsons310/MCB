  ...
  <head>
    ...
    <script>
      ...
      function printData(data){
        ...
        drawDonut(clight,posXlight,posYlight,data[3],lastLight,0,1023,'light-status',3);
        drawDonut(clight2,posXlight2,posYlight2,data[2],lastLight2,0,1023,'light2-status',3);
        //Last value
        ...
        document.getElementById("lastLight2").innerHTML = data[2];
      }
    ...
    <div id="page-content" style="float:left;height:1000px;color: #18699F;margin: 70px 0px 0px 200px;">
      ...
      <div id="control" style="height:309px;width:659px;margin:50px 0px 0px 60px;border: 1px solid gray;float:left;">
        <div id="control-text" class="sub-title"><span style="margin-left: 15px"> Control </span></div>
            ...
            <div style="font-size:25px;line-height:30px;vertical-align:middle;margin:20px 0px 0px 40px;">STATUS: <span id="LEDState"> ON </div>
        </div>
      </div>            
      <!-Graph-page-->      
